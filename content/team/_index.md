...
mission:
  ...
  title: "Plattformen, die tragen."
  lead: "Wir entwickeln, was wir empfehlen. Wir betreiben, was wir bauen. Wir lehren, was wir wissen."
  tags:
    - "Tragfähig"
    - "Skalierbar"
    - "Sicher"
...
how_we_work:
  ...
  cards:
    ...
    - title: "Enablement immer mit"
      body: "Was wir aufbauen, soll Ihr Team selbst weiterführen können."
    - title: "Offen, wo es geht"
      body: "Open Source als Standard, Eigenentwicklung nur, wo es Sinn macht."
why_cloud_native:
  eyebrow: "Warum Cloud Native?"
  title: "Fünf Eigenschaften, die zählen."
  pills:
    - "Skalierbarkeit"
    - "Sicherheit"
    - "Erweiterbarkeit"
...
values:
  ...
  items:
    - title: "Pragmatismus"
      body: "Was funktioniert, vor dem, was beeindruckt."
    - title: "Tiefe"
      body: "Lieber wenige Themen, dafür wirklich verstanden."
    - title: "Eigenverantwortung"
      body: "Wer übernimmt, trägt auch."
    - title: "Offenheit"
...
next_steps:
  ...
  cards:
    - eyebrow: "Services"
      title: "Was wir tun"
      desc: "Architekturberatung, Platform Engineering, Assessments und Trainings."
      href: "/services/"
    - eyebrow: "Produkte"
      title: "Womit wir bauen"
      desc: "Eigene Lösungen und ausgewählte Technologiepartner."
      href: "/produkte/"
---
